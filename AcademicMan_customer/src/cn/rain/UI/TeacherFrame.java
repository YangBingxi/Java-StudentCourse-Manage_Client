...
public class TeacherFrame extends JFrame {
	...
	JButton insertButton  = new JButton("录入成绩"), updatebutton = new JButton("修改成绩"), 
			statButton = new JButton("成绩统计"), findButton = new JButton("查询成绩");
	...
	public TeacherFrame(User teacher) {
		...
		statButton.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/sta.png")));
